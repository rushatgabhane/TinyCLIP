...
\begin{itemize}\setlength\itemsep{0pt}\setlength\topsep{0pt}\setlength\parsep{0pt}\setlength\partopsep{0pt}
    ...
    \item \textbf{GQA-2 is the sweet spot}: about 77\% of MHA overall and \textbf{93\% on CIFAR-100 at half the K/V parameters}; MQA trades far more accuracy for 4x compression.
    ...
    \item \textbf{Future work:} larger TinyCLIP (more heads to finer GQA sweep), longer uptraining, and vision-only vs.\ both-encoder ablation.
\end{itemize}
\color{Black}
